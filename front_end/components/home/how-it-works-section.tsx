          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="neomorph rounded-full h-16 w-16 flex items-center justify-center mb-6 relative">
                ...
                <span className="text-xl font-bold font-heading">{index + 1}</span>
              </div>
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-center">
            <div className="lg:col-span-2 space-y-4 text-center lg:text-left">
              <h3 className="text-2xl font-bold font-heading">Watch How It Works</h3>
              <p className="text-muted-foreground">
                See our platform in action and learn how easy it is to connect with healthcare professionals.
              </p>
            </div>
...
const steps = [
  {
    ...
    description:
      "Search and filter through our network of qualified doctors based on specialty, availability, and ratings.",
  },
  {
    icon: Calendar,
