import { Heart, Brain, Stethoscope, Pill, Activity, Eye, Bone, User } from "lucide-react"
...
export const doctorTypes: DoctorType[] = [
  {
    ...
    specialties: ["Cold & Flu", "Allergies", "Headache", "Stomach Issues", "Stress"]
  },
  {
    id: "cardio",
    title: "Cardiologist",
...
export const doctors: Doctor[] = [
  {
    ...
    about: "Dr. Sarah Johnson is a board-certified general practitioner with over 8 years of experience. She specializes in preventive care and managing chronic conditions. Her approach focuses on building long-term relationships with patients and providing comprehensive care.",
  ...
  },
  {
    ...
    about: "Dr. Michael Chen is dedicated to providing patient-centered care with a focus on preventive medicine. He believes in empowering patients through education and shared decision-making. With 6 years of experience, he has developed expertise in managing a wide range of health conditions.",
    doctorTypeId: "general",
    availability: [
      {
        day: "Tomorrow",
  ...
  },
  {
    ...
    about: "Dr. Emily Rodriguez has been practicing family medicine for 10 years. She is passionate about providing comprehensive care to patients of all ages. Her areas of interest include women's health, pediatric care, and managing chronic conditions. She takes a holistic approach to healthcare, considering physical, emotional, and social factors.",
    doctorTypeId: "general",
    availability: [
      {
        day: "Today",
  ...
  },
  {
    ...
    languages: ["English"],
    about: "Dr. James Wilson is a highly experienced cardiologist with 15 years of practice. He specializes in preventive cardiology, heart disease management, and hypertension treatment. He is known for his thorough approach and clear communication with patients about complex cardiac conditions.",
    doctorTypeId: "cardio",
    availability: [
      {
        day: "Tomorrow",
  ...
  },
  {
    ...
    about: "Dr. Olivia Thompson is a board-certified neurologist specializing in headache disorders, epilepsy, and neurodegenerative diseases. With 12 years of experience, she combines the latest research with compassionate care to help patients manage complex neurological conditions and improve their quality of life.",
    doctorTypeId: "neuro",
    availability: [
      {
        day: "Wednesday",
  ...
  },
  {
    ...
    about: "Dr. Robert Kim is a dermatologist with expertise in medical, surgical, and cosmetic dermatology. He treats a wide range of skin conditions including acne, eczema, psoriasis, and skin cancer. He is committed to providing personalized care and helping patients achieve healthy skin at any age.",
    doctorTypeId: "derma",
    availability: [
      {
        day: "Today",
