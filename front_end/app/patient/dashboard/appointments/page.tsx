    ...
    <div className="p-6">
      ...
      <Tabs defaultValue="upcoming" className="mb-6">
        <TabsList className="bg-white border border-gray-200">
          <TabsTrigger value="upcoming" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-900">
            Upcoming
          </TabsTrigger>
          <TabsTrigger value="past" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-900">
            Past
          </TabsTrigger>
          <TabsTrigger value="cancelled" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-900">
            Cancelled
          </TabsTrigger>
        </TabsList>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Dr. Michael Chen • Cardiology</p>
                    <div className="flex items-center gap-4 mt-2">
                      <div className="flex items-center gap-1 text-sm text-gray-500">
                        <Clock className="h-4 w-4" />
            ...
            <Card className="p-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-blue-900">Asthma Follow-up</h3>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <h2 className="text-lg font-bold text-blue-900 mb-4">Need to see a doctor?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="p-4 border-2 border-green-100 bg-green-50">
            <h3 className="font-medium text-green-800 mb-2">Virtual Consultation</h3>
            <p className="text-sm text-gray-600 mb-4">Connect with a doctor from home</p>
            <Button className="w-full bg-green-700 hover:bg-green-800">Start Virtual Visit</Button>
          </Card>

          <Card className="p-4 border-2 border-purple-100 bg-purple-50">
            <h3 className="font-medium text-purple-800 mb-2">Urgent Care</h3>
            <p className="text-sm text-gray-600 mb-4">Get immediate care for urgent needs</p>
            <Button className="w-full bg-purple-700 hover:bg-purple-800">Find Urgent Care</Button>
          </Card>
        </div>
      </div>
    </div>
