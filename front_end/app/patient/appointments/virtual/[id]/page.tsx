...
export default function VirtualAppointmentPage({ params }: VirtualAppointmentProps) {
            ...
            {isWaiting ? (
              <div className="text-center text-white">
                <div className="animate-pulse mb-4">
                  ...
                  <h2 className="text-xl font-semibold">Waiting for doctor to join...</h2>
                </div>
      ...
      <Dialog open={showEndConfirm} onOpenChange={setShowEndConfirm}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <DialogFooter className="flex gap-2 sm:justify-between">
            ...
            <Button variant="destructive" onClick={() => window.location.href = "/patient/appointments"}>
              End Appointment
            </Button>
          </DialogFooter>
        </DialogContent>
