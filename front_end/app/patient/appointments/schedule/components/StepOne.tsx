...
import { commonHealthIssues, chronicConditions, mentalHealth, specializedCare } from "../data"
...
export default function StepOne({ selectedReasons, onReasonSelect, isSelected }: StepOneProps) {
  return (
    <div className="mb-8">
