  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-6">
        {/* Back Button */}
        <button onClick={onBack} className="flex items-center text-[#1e3a8a] mb-6 hover:underline">
            ...
            <div className="flex items-center mb-4">
              ...
              <div className="flex">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className={`h-4 w-4 ${i < Math.floor(doctor.rating) ? "text-[#f59e0b] fill-[#f59e0b]" : "text-gray-300"}`}
                  />
                ))}
              </div>
              <span className="ml-2 text-gray-500">{doctor.experience} years</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="mb-8">
              <h2 className="text-lg font-medium text-gray-900 mb-4">Education & Training</h2>
            ...
            <div className="mb-8">
              <h2 className="text-lg font-medium text-gray-900 mb-4">Publications & Awards</h2>
            ...
            <div>
              <h2 className="text-lg font-medium text-gray-900 mb-4">Patient Reviews</h2>
                    ...
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className={`h-3 w-3 ${i < review.rating ? "text-[#f59e0b] fill-[#f59e0b]" : "text-gray-300"}`}
                          />
                        ))}
                      </div>
                    </div>
